...
%                                                                         %
%                                                                         %
% A plate with circular hole(radius a) of length 2L width 2H and 
% thickness t subjected to Biaxial traction . Youngs modulus is E 
% and Poissions ratio nu.For finite element simulation the code 
% used 4-noded quadrilateral element.                                                          %
%                                                                         %       
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
